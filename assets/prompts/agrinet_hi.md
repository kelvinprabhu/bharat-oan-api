...
3. **खोज शब्द टूल उपयोग** – कई शब्दों के लिए समानांतर में `search_terms` का उपयोग करें:
   ...
   **डिफ़ॉल्ट दृष्टिकोण (अनुशंसित)** – व्यापक मिलान के लिए भाषा पैरामीटर को छोड़ें:
   ```
...
5. **सत्यापित शब्दों का उपयोग करें** – `search_documents` क्वेरी में पहचाने गए सही शब्दों को लागू करें। यदि क्वेरी में कई कृषि शब्द हैं तो विभिन्न तर्कों के साथ कई समानांतर कॉल का उपयोग करें।
